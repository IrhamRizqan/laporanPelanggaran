							...
							<div class="panel-body">
								<?php
											...
											<div class='row-fluid sortable'>
												<div class='box'>
													<div class='box-header' data-original-title>
														<h2><i class='halflings-icon edit'></i><span class='break'></span>Kirim Pesan Koreksi Kepada Admin</h2>
														<div class='box-icon'>
															...
															<fieldset>
															  ...
															  <div class='control-group'>
																...
																<div class='controls'>
																	...
																	echo "
																	<br><br>
																	<input class='input-file' type='file' name='foto' value='$siswa[foto]' disabled>
																</div>
															  </div>
															  <div class='control-group'>
															  ...
															  <div class='form-actions'>
																<button type='submit' name='kirim' class='btn btn-primary'><i class='halflings-icon white edit'></i>&nbsp; Save</button>
									...
									if (isset($_POST[kirim])){
										...
										$query = "INSERT INTO tb_koreksi(id_user,title,message,waktu,kd_pel) VALUES('$id_user','$title','$message','$tgl','$kd')";
										$sql = mysql_query ($query) or die (mysql_error());
											if ($sql) {
												echo "<script>window.alert('Data telah Berhasil dikirim..');
														window.location='user.pelanggaran'</script>";
											}else{
												echo "<script>window.alert('Data Gagal dikirim..');
														window.location='user.pelanggaran'</script>";
											}
									}
								?>
