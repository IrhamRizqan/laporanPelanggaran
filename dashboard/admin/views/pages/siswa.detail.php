														...
														<form class='form-horizontal' action='' method='POST' enctype='multipart/form-data'>
															<fieldset>
															  ...
															  <div class='control-group'>
																...
																<div class='controls'>
																   <input class='input-xlarge disabled focused' id='focusedInput' type='text' name='nisn' value='$siswa[nisn]' disabled>
																</div>
															  </div>
															  <div class='control-group'>
															  ...
															  <div class='control-group'>
																...
																<div class='controls'>
																   <select data-placeholder='Pilih Tahun Masuk' class='span4 disabled' id='selectError3' name='thn_masuk' disabled>
															  ...
															  <div class='control-group'>
																...
																<div class='controls'>
																	<input class='input-xlarge disabled focused' id='focusedInput' type='text' name='asal_sekolah' value='$siswa[asal_sekolah]' disabled>
																</div>
															  </div>
															  <div class='control-group'>
																<label class='control-label' for='disabledInput'>Tanggal Lahir</label>
																<div class='controls'>
																  <select name='tgl' class='span2 disabled' id='selectError3' disabled>";
																		for ($i=1; $i<=31; $i++) {
																			$tg = ($i<10) ? "0$i" : $i;
																	...
																	<select name='bln' class='span2 disabled' id='selectError3' disabled>";
																		for ($j=1; $j<=12; $j++) {
																			$bl = ($j<10) ? "0$j" : $j;
																	...
																	<select name='thn' class='span2 disabled' id='selectError3' disabled>";
																		for ($i=1994; $i<=2000; $i++) {
																			$sele = ($i==$thn)?"selected" : "";
																			echo "<option value='$i' $sele>$i</option>";	
																		}
															  ...
															  <div class='control-group'>
																...
																<div class='controls'>
																	<input class='input-xlarge focused disabled' id='focusedInput' type='text' name='email' value='$siswa[email]' disabled>
																</div>
															  </div>
															  <div class='control-group'>
																<label class='control-label' for='disabledInput'>Agama</label>
																<div class='controls'>
																	<input class='input-xlarge focused disabled' id='focusedInput' type='text' name='agama' value='$siswa[agama]' disabled>
																</div>
															  </div>
															  <div class='control-group'>
																<label class='control-label' for='focusedInput'>No. Telpon Orang Tua</label>
																<div class='controls'>
																	<input class='input-xlarge focused disabled' id='focusedInput' type='text' name='telpon_ortu' value='$siswa[telpon_ortu]' disabled>
																</div>
															  </div>
															  <div class='control-group'>
											...
											echo " 
													<tr>
														...
														<td class='even' role='row'>
															<a href='pelanggaran.edit?aksi=edit&kd_pel=$data[kd_pel]' class='btn btn-info' title='Tambah Pelanggaran'><i class='halflings-icon white edit'></i></a>
