											...
											echo " 
													<tr>
														...
														<td class='even' role='row'>
															...
															<a href='pelanggaran?aksi=hapus&kd_pel=$data[kd_pel]' class='btn btn-danger' title='Hapus' onclick=\"return confirm('Yakin Akan Menghapus?')\"><i class='halflings-icon white trash'></i></a>
														</td>
													</tr>
											";
										}
