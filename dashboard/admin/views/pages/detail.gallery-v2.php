													...
													<div class='box-content'>
														...
														<form class='form-horizontal' action='' method='POST' enctype='multipart/form-data'>
															<fieldset>
															  ...
															  <div class='control-group'>
																<label class='control-label' for='disabledInput'>Foto Asli</label>
																<div class='controls'>
																	<img class='photo' src='assets/img/photos/$data[foto]'>
																</div>
															  </div>
															  <div class='control-group'>
																<label class='control-label' for='disabledInput'>Foto Galley</label>
																<div class='controls'> ";
																	$cekData="SELECT * from tb_gallery WHERE kd_gallery='$_GET[kd]'";
																	$cekData=mysql_query($cekData);
																	$foto = mysql_fetch_array($cekData);
																	echo "
																	<img class='photo' src='assets/img/gallery/$foto[foto]'>
																	<br><br>
