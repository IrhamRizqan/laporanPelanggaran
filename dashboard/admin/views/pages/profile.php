														...
														<form class='form-horizontal' action='' method='POST' enctype='multipart/form-data'>
															<fieldset>
															  ...
															  <div class='form-actions'>
																<a href='profile.edit?aksi=edit&id=$id[id_user]' class='btn btn-primary' title='Edit Data User'><i class='halflings-icon white edit'></i> Edit Data</a>
																<a href='edit.pass?aksi=edit&id=$id[id_user]' class='btn btn-info range2' title='Ganti Password'><i class='halflings-icon white edit'></i> Ganti Password</a>
															  </div>
															</fieldset>
														</form>
													</div>
