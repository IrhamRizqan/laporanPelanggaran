											...
											echo " 
													<tr>
														...
														<td class='odd' role='row'>
															<a href='users.admin?aksi=hapus&id_user=$row[id_user]' class='btn btn-danger' title='Hapus' onclick=\"return confirm('Yakin Akan Menghapus?')\"><i class='halflings-icon white trash'></i></a>
														</td>
													</tr>
											";
										}
